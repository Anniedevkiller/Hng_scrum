  ...
  return (
    <div className='py-14 grid gap-10 relative xl_up:mb-[350px]'>
        <div className='grid gap-y-5 xl_up:grid-cols-2 items-start xl_up:justify-end'>
            ...
            <img src='./images/work-in-africa/children.png' className='w-[100%] h-[300px] xl_up:h-[680px] object-cover'></img>
        </div>
        <div className='grid gap-y-5 xl_up:grid-cols-2 xl_up:items-end xl_up:absolute xl_up:top-[400px] '>
            <img src='./images/work-in-africa/hand-together.png' className='w-[100%] xl_up:pr-5 h-[300px] xl_up:h-[540px] object-cover order-last xl_up:order-first'></img>
