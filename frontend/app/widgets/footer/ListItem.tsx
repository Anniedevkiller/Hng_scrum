...
const ListItem = ({ title, links }: ListItemProps) => {
  return (
    <div className="flex flex-col gap-3 sm:gap-1">
      <h3 className="font-bold text-neutral-100 text-3xl sm:text-xl mb-4">{title}</h3>
  ...
  return (
    <div>
      <div className="flex gap-2">
        ...
        <p className="text-[20px] sm:text-base !font-normal text-neutral-100 uppercase m-0 mb-1">{country}</p>
      </div>
